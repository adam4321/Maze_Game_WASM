...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 32080,
    DYNAMIC_BASE = 5274960,
    DYNAMICTOP_PTR = 32064;
...
var wasmBinaryFile = 'wasm_maze.wasm';
...
var ASM_CONSTS = {
  3011: function() {return input;},  
 3064: function() {setTimeout(() => { window.history.back(); }, 800);},  
 3552: function() {if (input == "") { return 5; }},  
 3587: function() {input = 42;},  
 4897: function() {location.reload();}
};




// STATICTOP = STATIC_BASE + 31056;
...
var asmLibraryArg = { "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_throw": ___cxa_throw, "__map_file": ___map_file, "__sys_munmap": ___sys_munmap, "abort": _abort, "emscripten_asm_const_int": _emscripten_asm_const_int, "emscripten_cancel_main_loop": _emscripten_cancel_main_loop, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_main_loop": _emscripten_set_main_loop, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "strftime_l": _strftime_l, "table": wasmTable };
var asm = createWasm();
/** @type {function(...*):?} */
